    ...
    <div className="country-section">
      <div className="lg:flex justify-center items-center gap-16 w-3/4 mx-auto md:pt-20">
        <div className="w-full ">
          ...
          {
            isLoading ? <div className="w-1/4 mx-auto mt-12">
              <Loader></Loader>
            </div> : <div className="mt-8 grid grid-cols-2 gap-4 md:w-3/4 ">
              {countries.slice(0, visible).map(country => (
                <div key={country.id} className="country-card mt-4 w-full border">
                  <img src={country.flag} alt={country.name} className="h-6 w-6 " />
